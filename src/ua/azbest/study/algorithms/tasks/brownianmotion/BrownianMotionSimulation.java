package ua.azbest.study.algorithms.tasks.brownianmotion;
...
public class BrownianMotionSimulation {
    ...
    public static BrownianMotionSimulation makeSimulation(int N) {
		...
		particles[0] = new Particle(0.76,0.76,0,0,0.05,10.0,Color.GRAY);
	    for (int i = 1; i < N; i++) {
	    	double mass = 0.2;
	        particles[i] = new Particle(mass*0.02,mass,Color.ORANGE);
	    }
